...
class Zarlcode < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "415ac24eec8607bafbb04342598ce87675d869d57dc593133b4d2f1baeba1a59"
    else
      url "https://github.com/zarldev/zarlmono/releases/download/zarlcode/v0.1.2/zarlcode_v0.1.2_darwin_amd64.tar.gz"
      sha256 "9b0bece728bd6ce475500547ace6604e274df2770d721da0ac06d085a4bec4c4"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "943778686fad56845b1f6a4b5f513f7bce1a0b6573487881dd8d1d880d0f216a"
    else
      url "https://github.com/zarldev/zarlmono/releases/download/zarlcode/v0.1.2/zarlcode_v0.1.2_linux_amd64.tar.gz"
      sha256 "3100802c54dbbaff2fa1214f360cc9201824a7c531b00549a972a375ccae5c19"
    end
  end
