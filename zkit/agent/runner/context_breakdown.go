...
const (
	toolNameLoadSkill       = "skill_load"
	toolNameAgentAwait      = "agent_await"
	toolNameLoadInstruction = "instruction_load"
)
...
// ToolCalls that requested it) so skill_load / agent_await / instruction_load content can be
