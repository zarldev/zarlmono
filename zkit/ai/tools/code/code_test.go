...
func TestEditTool(t *testing.T) {
	...
	t.Run("generated file rejected", func(t *testing.T) {
		write("generated.go", "// Code generated by sqlc. DO NOT EDIT.\npackage generated\n")
		res := execTyped(t, tool, code.EditArgs{Path: "generated.go", OldString: "package generated", NewString: "package changed"})
		if res.Success {
			t.Fatal("expected generated-file refusal")
		}
