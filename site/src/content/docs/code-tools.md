...
| `edit` | Line/hash anchored edits from `read` output. Anchors usually survive line-number shifts from earlier edits; stale-anchor failures tell the model to re-read and retry with fresh anchors. |
